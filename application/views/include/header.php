...
<head>
    <meta charset="utf-8" />
    <title>Browse the Latest Job Hirings and Apply to Your Next Job Career Online | Worky.ph</title>
    ...
    <meta property="og:url" content="https://worky.ph/" />
    <!-- TWITTER OG TAGS -->
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="" />
    <meta name="twitter:description" content="" />
    <meta name="twitter:image" content="" />
    <meta name="twitter:url" content="https://worky.ph/" />

    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="google-signin-scope" content="profile email">
    <meta name="google-signin-client_id" content="950429035656-70sqdd97suogi4p0ig9n26qqs2joq3ek.apps.googleusercontent.com">
    <script src="https://apis.google.com/js/platform.js" async defer></script>
    <preference name="OverrideUserAgent" value="Mozilla/5.0 Google" />

    <!-- WORKY FAVICON [START] -->
    <link rel="shortcut icon" href="assets/worky/logo/worky_icon.png">
    <!-- WORKY FAVICON [END] -->
